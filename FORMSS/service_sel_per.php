...
.fa-user-tie {
  cursor: pointer;   /* gagawin siyang hand pointer */
}
...
/* Stack role buttons vertically on narrow screens */
...
<body>
 ...
 <div class="edp-welcome">
  <div class="welcome-inline">
    <span>Welcome, <span class="highlight">Personnel</span></span>
...
<main class="main">
  ...
  <a href="etarp.php" class="role">E-Tarp Design Request</a>
  <a href="wifi_e.php" class="role">Wi-fi Extension Request</a>
</div>
...
<div class="personnel-dropdown" id="personnelDropdown">
  <ul>
    <li id="personnelInfo"><i class="fas fa-user-graduate"></i> Personnel Info</li>
...
<script>
  const personnelIcon = document.querySelector('.fa-user-tie');
  ...
  personnelIcon.addEventListener('click', () => {
    dropdown.style.display = dropdown.style.display === 'block' ? 'none' : 'block';
  });

  // Pag-click sa Personnel Info → hide dropdown + show modal
...
<!-- Change Password Modal -->
<script>
  const changePasswordItem = document.getElementById('changePassword'); // dropdown item
  const passwordModal = document.getElementById('passwordModal');
  const closePasswordBtn = document.getElementById('closePasswordBtn'); // Close button
  const savePasswordBtn = document.getElementById('savePasswordBtn');
  const close = document.querySelector('.closebtn'); 

  // Pag-click sa Change Password → hide dropdown + show modal
...
<script>
  ...
  // Sample data (pwede palitan ng backend fetch)
  const historyData = [
  ...
  // ✅ Close modal via X icon (fixed target)
